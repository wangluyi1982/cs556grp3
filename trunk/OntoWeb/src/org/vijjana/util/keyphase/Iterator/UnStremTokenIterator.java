 ...
 * 
 */
public class UnStremTokenIterator extends KeyIterator implements Iterator {
	...
	public UnStremTokenIterator(String input, String patternStr) {
	...
	public static void main(String[] args) {
		...
		try {
			Iterator tokenIterator = new UnStremTokenIterator(str, patternStr);
			int i = 0;
